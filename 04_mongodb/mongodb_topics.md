...
## Large practice dataset (`02_database_mongo/` at repo root)

All code and CSVs for **`car_workshop_mongo`** (**100 interconnected collections**; **200k rows** in four fact tables; **~264k rows** total including dimensions) live in **[`02_database_mongo/`](../02_database_mongo/README.md)** — `generate_csv.py`, `seed_mongo.py`, `mongoimport_all.sh`, `dataset.py`.
