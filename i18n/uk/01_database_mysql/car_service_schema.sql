-- Файл лише зі схемою, згенерований з car_service_db.sql
-- Містить таблиці, індекси, первинні та зовнішні ключі
...
CREATE TABLE `vehicles` (
  ...
  `car` varchar(45) DEFAULT NULL COMMENT 'Застаріле поле для відображення; канонічне посилання на каталог — generation_id',
  `brand_id` int DEFAULT NULL COMMENT 'Необов''язковий денормалізований кеш бренду; за наявності — похідне від generation_id',
  `body_type_id` int DEFAULT NULL,
  `color_id` int DEFAULT NULL,
  `fuel_type_id` int DEFAULT NULL,
  `transmission_id` int DEFAULT NULL,
  `generation_id` int DEFAULT NULL COMMENT 'Канонічне посилання на каталог car_generations',
