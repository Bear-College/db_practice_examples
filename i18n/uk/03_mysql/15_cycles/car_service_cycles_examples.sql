-- Цикли: процедурні (WHILE / REPEAT / LOOP) + рекурсивний CTE — car_service_db
-- MySQL 5.7+ (процедури), 8.0+ (WITH RECURSIVE). Клієнт mysql для DELIMITER.
...
-- C2 — REPEAT … UNTIL (умова перевіряється після кожної ітерації)
...
-- C3 — LOOP з LEAVE (іменована мітка)
...
-- C4 — Цикл курсора по кількох рядках work_orders (id обмежено)
...
-- =============================================================================
-- C5 — Рекурсивний CTE (MySQL 8.0+): згенерувати 1..N без процедурного циклу
-- =============================================================================
...
-- =============================================================================
-- Опціонально: видалити процедури / таблицю по завершенні
-- =============================================================================
-- DROP PROCEDURE IF EXISTS sp_cyc_while_demo;
-- DROP PROCEDURE IF EXISTS sp_cyc_repeat_demo;
-- DROP PROCEDURE IF EXISTS sp_cyc_loop_leave_demo;
