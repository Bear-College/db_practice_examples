...
This lesson uses **PyMongo** and runs against the MongoDB practice database from `database_mongo/`.
...
```bash
MONGODB_DB=your_database_name python mongodb/01_crud/example.py
```
